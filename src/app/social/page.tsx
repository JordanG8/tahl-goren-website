          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="flex items-center justify-between border-b border-outline/20 pb-4">
                ...
                <a href="https://www.instagram.com/tahlgoren/" target="_blank" rel="noopener noreferrer" className="font-label font-medium text-[13px] uppercase tracking-[0.13em] font-bold text-secondary hover:text-primary transition-colors">מעבר לפרופיל</a>
              </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <a href="https://www.facebook.com/tahlgoren" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-white px-8 py-3 font-headline font-bold text-xs uppercase tracking-[0.13em] hover:opacity-90 transition-opacity">עקבו בפייסבוק</a>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <a href="https://www.youtube.com/channel/UCme0hzUzQzMlsqO394pF3mg/" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-white px-8 py-3 font-headline font-bold text-xs uppercase tracking-[0.13em] hover:opacity-90 transition-opacity">צפו ביוטיוב</a>
                </div>
              </div>
            </div>
