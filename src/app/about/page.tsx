...
export const aboutExcerpt = `בעלת ניסיון של מעל 25 שנה. המשרד מתמחה אך ורק בתכנון בתים פרטיים ללקוחות פרטיים באזור השרון הצפוני, יישובי מנשה, חוף הכרמל והסביבה. המומחיות של טל היא יצירת "בתים שגדלים עם המשפחה" – תכנון גמיש, פרקטי וחסכוני, המלווה ביחס אישי צמוד ובביטחון מקצועי מלא.`;
