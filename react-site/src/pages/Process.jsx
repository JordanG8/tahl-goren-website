    ...
    <>
      ...
      <section className="relative py-24 md:py-36 px-8 blueprint-grid overflow-hidden">
        <div className="max-w-6xl mx-auto flex flex-col items-start gap-6 relative z-10 reveal">
          ...
          <div className="mt-12">
            <Link to="/contact" className="inline-flex items-center gap-4 bg-primary text-white px-10 py-5 font-headline font-black text-sm uppercase tracking-widest hover:opacity-90 transition-all group">
              התחילו את המסע
