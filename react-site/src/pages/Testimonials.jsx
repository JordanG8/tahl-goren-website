        ...
        <section className="py-20 md:py-28 px-8 bg-surface reveal">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="font-body text-lg md:text-xl text-secondary max-w-2xl leading-relaxed mt-8">
              הסיפוק הגדול ביותר שלי כאדריכלית הוא לראות לקוחות מרוצים שנהנו מהדרך. זה לא פחות חשוב מהתוצאה הסופית. אני מאמינה שבית מוצלח הוא תמיד פרי של שיתוף פעולה פורה והקשבה. מוזמנים לקרוא מה מספרות משפחות שכבר בנו איתי את בית חלומותיהן.
            </p>
