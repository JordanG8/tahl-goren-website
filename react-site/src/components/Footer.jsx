        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24">
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 font-label text-sm text-secondary">
              <Link to="/projects" className="hover:text-primary transition-colors">פרויקטים</Link>
              <Link to="/process" className="hover:text-primary transition-colors">תהליך העבודה</Link>
              ...
              <Link to="/articles" className="hover:text-primary transition-colors">מאמרים</Link>
              <Link to="/faq" className="hover:text-primary transition-colors">שאלות ותשובות</Link>
            </div>
          </div>
          <div className="space-y-4">
