        ...
        <div className="flex justify-between items-center px-8 py-6 max-w-[1920px] mx-auto">
            ...
            {desktopLinks.map((link) => (
              <Link
                ...
                className={`transition-colors duration-300 ${
                  location.pathname === link.to ? 'nav-active text-primary' : 'text-secondary hover:text-primary'
                }`}
              >
                {link.label}
              </Link>
          ...
          <div className="flex items-center gap-4 order-1 lg:order-3">
            <div className="hidden lg:flex items-center gap-4 border-r border-outline/20 pr-4 mr-4">
              ...
              <a href="https://www.instagram.com/tahlgoren/" target="_blank" rel="noreferrer" className="text-primary hover:text-secondary transition-colors" title="Instagram">
            ...
            <Link to="/contact" className="hidden sm:block bg-primary text-white px-8 py-2 font-headline font-bold text-xs uppercase tracking-widest hover:opacity-80 transition-opacity">
              צור קשר
            </Link>
